...
def records_equal(record1: Record, record2: Record):
    """
...
def read_file_n10s_and_rdflib(neo4j_driver, graph_store, batching=False, n10s_params={"handleVocabUris": "IGNORE"}):
    ...
    return records_from_rdf_lib, records
